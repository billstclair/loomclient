...
require_once "LoomRandom.php";
   ...
   * From http://world.std.com/%7Ereinhold/diceware.wordlist.asc
   */
...
class Diceware {
  ...
  function Diceware($random=false) {
  ...
  function random_words($count) {
    ...
    for ($i=0; $i<$count; $i++) {
      if ($res != "") $res .= " ";
      $res .= $this->random_word();
    }
    return $res;
  }

  function rawtext() {
    // This is the official Diceware word list, with the dice numbers removed,
    // and a backslash escaping the double-quote.
    return 
"a
a&p
a's
...
} // end of Diceware class

/*

$diceware = new Diceware();
echo $diceware->random_words(5) . "\n";
